...
*Due by 11:59 PM Sunday, April 5, 2020 by email*

- [<i class="fas fa-file-pdf"></i> `Download as PDF`](/assignment/02-problem-set-pdf.pdf)
- [<i class="far fa-life-ring"></i> `Answer Key`](/assignment/02-problem-set-answers-pdf.pdf)
...
What makes a threat credible? In your answer, use the concept of subgame perfection.
