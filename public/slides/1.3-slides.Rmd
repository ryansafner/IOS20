...
.smallest[
1. Write equations for fixed costs, variable costs, average fixed costs, average variable costs, and for average (total) costs.

2. Suppose the firm is in a competitive market, and the current market price is $4, how many units of output maximize profits?

3. How much profit will this firm earn?

4. At what market price would the firm break even $(\pi=0)$?

5. Below what market price would the firm shut down in the short run if it were earning losses?
]