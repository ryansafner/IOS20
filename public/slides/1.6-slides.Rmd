...
# Perfectly Competitive Market: Takeways
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  geom_point(x=3,y=7, size=3)+
  geom_text(x=3.5,y=7.5,label=expression(paste("(",q^x,", ",p^x,")")), size=5)+
...
.pull-left[
.center[
![:scale 40%](https://www.dropbox.com/s/espsohk14lgh4ef/hairbraidingnpr.png?raw=1)
]
]
...
- .hi-purple[Tradeoff between incentivizing monopolist with profits and reducing harms of monopoly]
]
