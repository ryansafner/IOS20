---
title: "1.9: Imperfect Competition"
...
2. .hi-purple[Entry and exit are free] (no barriers)
...
- **Perfect competition** $(q_c, p_c)$
  ...
  - $p=AC_{min}$, .hi-purple[productively efficient]
  - $q_c$ where $P=MC(q)$
...
- Oligopoly: we can use game-theoretic .hi-purple[Nash Equilibrium]: 
...
.pull-left[
.center[
![:scale 100%](https://www.dropbox.com/s/g2f7gxof36lewgb/pricematch.png?raw=1)
]
]

.pull-right[
- Detection & retaliation of retail price-cutting: "price match" or "most favored customer" policies

- Loudly claim to match or beat competitors' prices

- Appears to promote competition...
...
.pull-right[
- .hi-green[Example]: Suppose L.L. Bean and Land's End tacitly agree to sell flannel shirts above market price at $80
...
- Extra clever: use customer, incentivized to find lowest $p$, to detect cheating!
]
...
.center[
![:scale 100%](https://www.dropbox.com/s/ild2a28u99mui7b/robberbarons.png?raw=1)
]
