...
.pull-left[
.center[
![](https://www.dropbox.com/s/cyg89bpljib6xoa/naics.png?raw=1)
]
]
...
- Places production into one of 1,004 4-digit industries
...
.pull-right[
- Recall the Lerner index for measuring market power and markup:
$$L=\frac{p-MC}{p}$$
  - $L=1$: monopoly
  - $L=0$: perfectly competitive
...
- What if demand shifts to Demand$_2$? Same problem! 

1. Competitive firms set $MC_c$ equal to new demand 2 to get $p_2$ at $q_2$

2. Cartel sets $MC_c$ equal to new $MR_2$ at $q_2$, mark up to $p_2$ 
