...
- ... which is determined by the product's .hi-purple["Technology"]
  ...
  - Good's characteristics: inputs, technology, durability, rivalry, excludability
...
- Firms grapple with their own .hi-purple[principle-agent problems]: 
...
4. How should we regulate platforms like Facebook, Amazon, Google, etc. uniquely problematic?
