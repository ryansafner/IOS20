...
.pull-right[
- **Some factors are relatively .ul[in the economy]**
...
- **Scarce factor owners** (workers, landowners, inventors, etc) **earn the rents as higher income for their services** (wages, rents, interest, royalties, etc).
...
- .hi[Economies of scale] are **internal** to the firm (a firm's own average cost curve)

- .hi[.ul[External] economies] have to do with how the size of the *entire* industry affects *all individual firm's costs*
...
- .hi[Increasing cost industry] has .hi-purple[external diseconomies], **costs rise for all firms** in the industry as industry output increases (firms enter & incumbents produce more)

- An *upward sloping long-run industry supply curve*!

- Finding more inputs in harder-to-reach places
- Diminishing marginal products
- Greater complexity & admin. costs
...
- .hi[Decreasing cost industry] has .hi-purple[xternal economies], **costs fall for all firms** in the industry as industry output increases (firms enter & incumbents produce more)
